 ...
 * @author dailiang
 */
public class ProductPropertyComparator extends BaseComparator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        comparator.comparator("product_property_1-0302.csv", "product_property_2-0302.csv",  1, null, null, null);
    }
}
