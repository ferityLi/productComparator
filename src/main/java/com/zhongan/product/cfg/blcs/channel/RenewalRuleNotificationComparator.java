 ...
 * @author dailiang
 */
public class RenewalRuleNotificationComparator extends BaseComparator {
    ...
    public static void main(String[] args) throws Exception {
        RenewalRuleNotificationComparator comparator = new RenewalRuleNotificationComparator();
