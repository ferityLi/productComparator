 ...
 * @author dailiang
 */
public class PartnerExtraInfoComparator extends BaseComparator {
    ...
    public static void main(String[] args) throws Exception {
        PartnerExtraInfoComparator comparator = new PartnerExtraInfoComparator();
        comparator.createFile(TABLE_NAME);
        comparator.comparator("partner_extra_info-v1-0303.csv", "partner_extra_info-v2-0303.csv",  1, null, null, null);
    }
}
